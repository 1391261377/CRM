...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#activityName").keydown(function (event) {
			if (event.keyCode==13){
				$.ajax({
					url: "${pageContext.request.contextPath}/clue/getActivityListByNameAndNotByClueId",
					data: {
		...
		$("#bundBtn").click(function () {
			...
			if ($xz.length==0){
				...
				$.ajax({
					url: "${pageContext.request.contextPath}/clue/bund",
					data:
						param,
					type: "post",
					dataType: "json",
	...
	function showActivityList() {
		...
		$.ajax({
			url: "${pageContext.request.contextPath}/clue/getActivityList",
			data: {
				"clueId":"${clue.id}"
			},
			type: "get",
	...
	function unbund(id) {
		...
		$.ajax({
			url: "${pageContext.request.contextPath}/clue/unbund",
			data: {
				"id":id
			},
			type: "post",
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='${pageContext.request.contextPath}/static/workbench/clue/convert.jsp?id=${clue.id}&fullname=${clue.fullname}&appellation=${clue.appellation}&company=${clue.company}&owner=${clue.owner}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<div class="remarkDiv" style="height: 60px;">
			<img title="zhangsan" src="${pageContext.request.contextPath}/static/image/user-thumbnail.png" style="width: 30px; height:30px;">
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>哎呦！</h5>
