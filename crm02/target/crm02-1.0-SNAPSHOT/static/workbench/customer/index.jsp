...
<script type="text/javascript">
	...
	function pageList(pageNo, pageSize) {
		...
		$.ajax({
			url: "${pageContext.request.contextPath}/customer/pageList",
			data: {
				"pageNo": pageNo,
				"pageSize": pageSize,
			...
			success: function (data) {
				...
				$.each(data.dataList, function (i, n) {
					html += '<tr class="customer" id="customerBody">';
					...
					html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'${pageContext.request.contextPath}/static/workbench/customer/detail.html\';">'+n.name+'</a></td>';
					html += '<td>' + n.owner + '</td>';
					html += '<td>' + n.phone + '</td>';
