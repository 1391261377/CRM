    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#saveRemarkBtn").click(function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/activity/saveRemarkBnt",
                    data: {
                    ...
                    success: function (data) {
                        ...
                        if (data.success){
                            ...
                            html+=' <img title="zhangsan" src="${pageContext.request.contextPath}/static/image/user-thumbnail.png" style="width: 30px; height:30px;">';
            ...
            $("#updateRemarkBtn").click(function () {
                ...
                var id = $("#remarkId").val();
                $.ajax({
                    url: "${pageContext.request.contextPath}/activity/updateRemark",
                    data: {
                        "id":id,
                    ...
                    success: function (data) {
                        if (data){
                            //更新 div 中相应的信息     noteContent editTime editBy
        ...
        function showRemarkList() {
            $.ajax({
                url: "${pageContext.request.contextPath}/activity/getRemarkListById",
                data: {
                    "activityId":"${requestScope.a.id}"
                },
                type: "get",
        ...
        function deleteRemark(id) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/activity/deleteRemark",
                data: {
                    "id":id
                },
                type: "post",
