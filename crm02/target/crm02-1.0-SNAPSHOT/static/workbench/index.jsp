...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            window.open("${pageContext.request.contextPath}/static/workbench/main/index.jsp"
            , "workareaFrame");
            ...
            <li class="dropdown user-dropdown">
                <a href="javascript:void(0)" style="text-decoration: none; color: white;" class="dropdown-toggle"
                   data-toggle="dropdown">
                    ...
                    ${user.name}
                    <span class="caret"></span>&nbsp; &numsp; &numsp; &numsp; &numsp; &numsp;
                </a>
                <ul class="dropdown-menu">
                    <li><a href="${pageContext.request.contextPath}/static/settings/index.html"><span class="glyphicon glyphicon-wrench"></span> 系统设置</a></li>
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            <li class="liClass"><a href="${pageContext.request.contextPath}/static/workbench/main/index.jsp" target="workareaFrame"><span
            ...
            <li class="liClass"><a href="${pageContext.request.contextPath}/static/workbench/activity/show.jsp" target="workareaFrame"><span
                    class="glyphicon glyphicon-play-circle"></span> 市场活动</a></li>
            <li class="liClass"><a href="${pageContext.request.contextPath}/static/workbench/clue/index.jsp" target="workareaFrame"><span
                    class="glyphicon glyphicon-search"></span> 线索（潜在客户）</a></li>
            <li class="liClass"><a href="${pageContext.request.contextPath}/static/workbench/customer/index.jsp" target="workareaFrame"><span
                    class="glyphicon glyphicon-user"></span> 客户</a></li>
            <li class="liClass"><a href="${pageContext.request.contextPath}/static/workbench/contacts/index.jsp" target="workareaFrame"><span
                    class="glyphicon glyphicon-earphone"></span> 联系人</a></li>
            <li class="liClass"><a href="${pageContext.request.contextPath}/static/workbench/transaction/index.jsp" target="workareaFrame"><span
                    class="glyphicon glyphicon-usd"></span> 交易（商机）</a></li>
            <li class="liClass"><a href="${pageContext.request.contextPath}/static/workbench/visit/index.html" target="workareaFrame"><span
            ...
            <li class="liClass">
                ...
                <ul id="no2" class="nav nav-pills nav-stacked collapse">
                    <li class="liClass"><a href="${pageContext.request.contextPath}/static/workbench/chart/activity/index.jsp"
                                           target="workareaFrame">&nbsp;&nbsp;&nbsp;<span
                            class="glyphicon glyphicon-chevron-right"></span> 市场活动统计图表</a></li>
                    <li class="liClass"><a href="${pageContext.request.contextPath}/static/workbench/chart/clue/index.jsp" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span
                            class="glyphicon glyphicon-chevron-right"></span> 线索统计图表</a></li>
                    <li class="liClass"><a href="${pageContext.request.contextPath}/static/workbench/chart/customerAndContacts/index.jsp" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span
                            class="glyphicon glyphicon-chevron-right"></span> 客户和联系人统计图表</a></li>
                    <li class="liClass"><a href="${pageContext.request.contextPath}/static/workbench/chart/transaction/index.jsp" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span
