...
<%@ page import="cn.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="cn.crm.workbench.domain.Tran" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function showHistoryList() {
            $.ajax({
                url: "${pageContext.request.contextPath}/transaction/getHistoryListByTranId",
                data: {
                    "tranId": "${t.id}"
                },
                type: "get",
        ...
        function changeStage(stage, i) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/transaction/changeStage",
                data: {
                    "id": "${t.id}",
                    "stage": stage,
                ...
                success: function (data) {
                    if (data) {
                        ...
                        //改变阶段成功
                        //需要在详细信息页上局部刷新，刷新阶段，可能性，修改人，修改时间
...
<div style="position: relative; top: 0px;">
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 60px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;">
            <b>${t.createBy}&nbsp;&nbsp;</b>
            <small style="font-size: 10px; color: gray;">${t.createTime}</small></div>
        <div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
    </div>
    <div style="position: relative; left: 40px; height: 30px; top: 70px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;">
            ...
            <small id="editTime" style="font-size: 10px; color: gray;">${t.editTime}</small></div>
        <div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
    </div>
...
<div style="position: relative; top: 100px; left: 40px;">
    ...
    <div class="remarkDiv" style="height: 60px;">
        <img title="zhangsan" src="${pageContext.request.contextPath}/static/image/user-thumbnail.png"
