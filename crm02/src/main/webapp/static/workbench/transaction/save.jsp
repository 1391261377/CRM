...
<%@ page import="org.apache.ibatis.session.defaults.DefaultSqlSession" %>
...
<head>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/jquery/bs_typeahead/bootstrap3-typeahead.min.js"></script>
    <title></title>
    <script>
        ...
        $(function () {
            ...
            $("#create-customerName").typeahead(
                {
                    source: function (query, process) {
                        $.get(
                            "${pageContext.request.contextPath}/transaction/getCustomerName",
                            {"name": query},
                            function (data) {
                                process(data);
                            },
            ...
            $("#cancelBtn").click(function () {
                window.location.href="${pageContext.request.contextPath}/static/workbench/transaction/index.jsp"
            })
        })
...
<form class="form-horizontal"  id="tranForm" action="${pageContext.request.contextPath}/transaction/save" method="post" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <select class="form-control" id="create-clueSource" name="source">
                <option></option>
                <c:forEach items="${sourceList}" var="e">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-activitySrc" value="第一次测试">
            <input type="hidden" value="12131feb15f740e68dd4205ef39cdc2b" name="activityId">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" value="7d7e9bb4b76d4460b9ad4cb80da93asd" name="contactsId">
        </div>
    </div>
