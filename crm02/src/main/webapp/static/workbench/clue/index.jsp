...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#addBtn").click(function () {
			...
			$.ajax({
				url: "${pageContext.request.contextPath}/clue/gitUserList",
				type: "get",
				dataType: "json",
		...
		$("#saveBtn").click(function () {
			$.ajax({
				url: "${pageContext.request.contextPath}/clue/save",
				data: {
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}/clue/detail?id=eab78376585e48e7bc3d8a5ec0c82d23';">胡先生</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
